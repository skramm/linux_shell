# Documentation de `journalctl`, générée via `man`

[Liste alphabétique](../linux_cmds_list_alpha.md) - [Liste par catégorie](../linux_cmds_list_cat.md)

[Recherche Google](https://www.google.fr/search?q=linux+journalctl)
...
## DESCRIPTION
       ...
       lines of level ERROR and higher are colored red; lines of level WARNING
       are colored yellow; lines of level NOTICE are highlighted; lines of
       level INFO are displayed normally; lines of level DEBUG are colored
       grey.

       To write entries to the journal, a few methods may be used. In general,
       output from systemd units is automatically connected to the journal,
...
## OUTPUT OPTIONS
       ...
       -o, --output=
           ...
           json
               ...
               characters (see Journal JSON Format[4] for more information).
           ...
           cat
               ...
               If combined with the --output-fields= option will output the
