...
<a href='https://www.google.fr/search?q=linux+ln'>Google search</a>
...
## SYNOPSIS
       ln [OPTION]... [-T] TARGET LINK_## NAME
       ln [OPTION]... TARGET
       ln [OPTION]... TARGET... DIRECTORY
       ln [OPTION]... -t DIRECTORY TARGET...

## DESCRIPTION
       In  the  1st form, create a link to TARGET with the name LINK_## NAME.  In
       ...
       -n, --no-dereference
              treat LINK_## NAME as a normal file if it is a symbolic link  to  a
              directory
       ...
       -T, --no-target-directory
              treat LINK_## NAME as a normal file always
