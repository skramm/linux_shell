...
<a href='https://www.google.fr/search?q=linux+rpm'>Google search</a>
...
## SYNOPSIS
   ...
   INSTALLING, UPGRADING, AND REMOVING PACKAGES:
       ...
       scripts] [--notriggers] [--test] PACKAGE_## NAME ...
   ...
   select-options
       [PACKAGE_## NAME] [-a,--all [SELECTOR]]  [-f,--file  FILE]  [--path  PATH]
       [-g,--group  GROUP] [-p,--package PACKAGE_FILE] [--hdrid SHA1] [--pkgid
       MD5] [--tid TID] [--querybynumber HDRNUM] [--triggeredby  PACKAGE_## NAME]
...
## DESCRIPTION
   ...
   ERASE ## OPTIONS
       ...
       [--notriggers] [--test] PACKAGE_## NAME ...

       The following options may also be used:

       --allmatches
              Remove  all  versions  of  the package which match PACKAGE_## NAME.
              Normally an error is issued  if  PACKAGE_## NAME  matches  multiple
              packages.
   ...
   PACKAGE SELECTION ## OPTIONS:
       PACKAGE_## NAME
              Query installed package  named  PACKAGE_## NAME.   To  specify  the
       ...
       --triggeredby PACKAGE_## NAME
              Query packages that are triggered by package(s) PACKAGE_## NAME.
   ...
   MISCELLANEOUS COMMANDS
       ...
       rpm --setperms | --setugids | --setcaps PACKAGE_## NAME
