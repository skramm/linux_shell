...
<a href='https://www.google.fr/search?q=linux+modprobe'>Google search</a>
...
## OPTIONS
       ...
       -C, --config
           ...
           modprobe commands in the MODPROBE_## OPTIONS environment variable.
       ...
       --force-modversion
           When modules are compiled with CONFIG_MOD## VERSIONS set, a section
...
## ENVIRONMENT
       The MODPROBE_## OPTIONS environment variable can also be used to pass
