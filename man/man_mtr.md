...
<a href='https://www.google.fr/search?q=linux+mtr'>Google search</a>
...
## SYNOPSIS
       mtr  [-4|-6]  [-F FILE## NAME]  [--report] [--report-wide] [--xml] [--gtk]
...
## DESCRIPTION
       ...
       mtr  runs  on  and HOST## NAME by sending packets with purposely low TTLs.
       ...
       centage and response times of the internet route to HOST## NAME.  A sudden
...
## ENVIRONMENT
       ...
       MTR_## OPTIONS
              ...
              in MTR_## OPTIONS are overridden by command-line options.

              Example:

              MTR_## OPTIONS="-4 -c 1" mtr -6 localhost

              would  send  one probe (because of -c 1) towards ::1 (because of
              -6, which overrides the -4 passed in MTR_## OPTIONS).
