...
<a href='https://www.google.fr/search?q=linux+rsync'>Google search</a>
...
## OPTIONS
       ...
       --ignore-existing
              ...
              When  --info=skip2  is  used  rsync will output "FILE## NAME exists
...
FILTER RULES
   ...
   FILTER RULES IN DEPTH
       ...
       RULE from the MODIFIERS is optional.  The PATTERN or FILE## NAME that fol‐
...
## ENVIRONMENT VARIABLES
       ...
       USER or LOG## NAME
              The USER or LOG## NAME environment variables are used to  determine
