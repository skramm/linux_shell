...
<a href='https://www.google.fr/search?q=linux+su'>Google search</a>
...
## DESCRIPTION
       ...
       (plus USER and LOG## NAME if the target user is not root). It is
...
## OPTIONS
       ...
       -m, -p, --preserve-environment
           ...
           or LOG## NAME. This option is ignored if the option --login is
           specified.
