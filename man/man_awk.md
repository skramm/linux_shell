...
<a href='https://www.google.fr/search?q=linux+awk'>Google search</a>
...
VARIABLES, RECORDS AND FIELDS
   ...
   Built-in Variables
       ...
       FILE## NAME    The name of the current input file.  If no files are speci‐
                   fied on the command line, the value  of  FILE## NAME  is  “-”.
                   However,  FILE## NAME  is undefined inside the BEGIN rule (un‐
                   less set by getline).
   ...
   Variable Typing And Conversion
       ...
       fields,  getline  input,  FILE## NAME, ARGV elements, ENVIRON elements and
...
PATTERNS AND ACTIONS
   ...
   I/O Statements
       ...
       nextfile              Stop processing the current input file.  The next
                             ...
                             Update FILE## NAME and ARGIND, reset FNR to  1,  and
