# Manuel de `pkg-config`

[alpha list](../linux_cmds_list_alpha.md) - [cat list](../linux_cmds_list_cat.md)

<a href='https://www.google.fr/search?q=linux+pkg-config'>Google search</a>
...
QUERY-SPECIFIC ## OPTIONS
       ...
       --define-variable=VAR## NAME=VALUE
               Define  VAR## NAME  as VALUE.  Variables are used in query output,
...
## ENVIRONMENT
       ...
       PKG_CONFIG_SYSTEM_## LIBRARY_PATH
...
Debian                         November 15, 2016                    PKGCONF(1)
