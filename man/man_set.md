...
<a href='https://www.google.fr/search?q=linux+set'>Google search</a>

---
SET(7)                  PostgreSQL 16.13 Documentation                  SET(7)
...
## DESCRIPTION
       ...
       run-time parameters listed in Chapter 20 can be changed on-the-fly with
       SET. (Some parameters can only be changed by superusers and users who
       have been granted SET privilege on that parameter. There are also
       parameters that cannot be changed after server or session start.)  SET
...
PARAMETERS
       ...
       Besides the configuration parameters documented in Chapter 20, there
       ...
       TIME ZONE
           ...
           Time zone abbreviations are not supported by SET; see Section 8.5.3
           for more information about time zones.

## NOTES
       The function set_config provides equivalent functionality; see
       Section 9.27.1. Also, it is possible to UPDATE the pg_settings system
