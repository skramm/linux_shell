# Documentation de `htop`, générée via `man`

[Liste alphabétique](../linux_cmds_list_alpha.md) - [Liste par catégorie](../linux_cmds_list_cat.md)

[Recherche Google](https://www.google.fr/search?q=linux+htop)
...
## DESCRIPTION
       ...
       guments, as well as  view  them  in  a  tree  format,  select  multiple
...
INTERACTIVE COMMANDS
       ...
       F3, /
            ...
            processes.  The  currently selected (highlighted) command will up‐
            date as you type. While in search mode,  pressing  F3  will  cycle
            through  matching occurrences.  Pressing Shift-F3 will cycle back‐
            wards.
